...
SELECT 
    ...
    cp.type AS counterparties__type,
    cp.parent_id AS counterparties__parent_id,
    cp.name AS counterparties__name,

    r.id AS robots__id,
    r.user_id AS robots__user_id,
    r.account_id AS robots__account_id,
    r.article_id AS robots__article_id,
    r.project_id AS robots__project_id,

    aan.article_id AS article_alternative_names__article_id,
